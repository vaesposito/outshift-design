...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles shown on the homepage and blog listing';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage configuration and content';
  ...
  attributes: {
    blogSectionDescription: Schema.Attribute.Text;
    blogSectionTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Latest from Our Blog'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerLinks: Schema.Attribute.Component<'shared.arrow-link', true>;
    heroCtaLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'See Our Work'>;
    heroCtaUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#initiatives'>;
    heroDescription: Schema.Attribute.Text;
    heroSubtitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'We evolve faster'>;
    heroTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Design evolves fast'>;
    initiativesSectionSubtitle: Schema.Attribute.Text;
    initiativesSectionTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Featured Initiatives'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    researchSectionDescription: Schema.Attribute.Text;
    researchSectionTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Innovation & Research'>;
    seo: Schema.Attribute.Component<'shared.seo-meta', false>;
...
export interface ApiInitiativeInitiative extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Featured initiative cards shown on the homepage';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    link: Schema.Attribute.Component<'shared.arrow-link', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiResearchCardResearchCard
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::research-card.research-card'
    > &
      Schema.Attribute.Private;
    media: Schema.Attribute.Component<'shared.media-block', false> &
      Schema.Attribute.Required;
