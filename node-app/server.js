...
const fallbackData = {
  ...
  blogPosts: [
    ...
    { title: 'The Strategic Role of Design in Shaping Ethical AI Systems', description: 'How interface design becomes the primary control layer for responsible human–AI interaction.', author: 'Outshift by Cisco', date: 'May 2026', readTime: 'Whitepaper', href: '/blog' },
  ],
  blogHub: [
...
const fallbackHaxPatterns = [
  ...
  },
  {
    ...
    relatedPatterns: [
      { subnavId: 'clarity-ir', name: 'Inline Rationale', description: 'Agents articulate why they made recommendations. Rationale should be accessible, understandable, and relevant to help users make sense of the thinking.', componentLabel: 'Component example: Inline Rationale', callouts: [{ num: 1, title: 'Agent\'s reasoning surfaced', desc: 'The agent labels its own decision logic, making invisible prioritization visible so users can understand, question, or reorder.' }, { num: 2, title: 'Reasoning is accessible, not buried', desc: 'Rationale appears directly within the interface at the point of action.' }, { num: 3, title: 'User can act directly from the rationale view', desc: 'The interface allows users to approve, modify, or reject directly from where rationale is shown.' }] },
      { subnavId: 'clarity-cd', name: 'Confidence & Uncertainty Displays', description: 'Disclosing confidence levels helps users interpret outcomes effectively and calibrate trust appropriately for transparent decision support.', componentLabel: 'Component example: Diagnostic Report', callouts: [{ num: 1, title: 'Confidence scores are shown inline', desc: 'Each finding includes a visual confidence bar so users can quickly assess reliability at a glance.' }, { num: 2, title: 'Actionable items are surfaced clearly', desc: 'The interface distinguishes findings that require action from those that are informational.' }, { num: 3, title: 'Uncertainty is visualised, not hidden', desc: 'Low-confidence results are shown with reduced fill and a distinct label.' }, { num: 4, title: 'Context is preserved per finding', desc: 'Each row includes its category and source, giving users the context to act.' }] },
      { subnavId: 'clarity-sa', name: 'Source Attribution', description: 'Revealing where information came from helps users verify and contextualize outputs, supporting accountability and enabling further inquiry.', componentLabel: 'Component example: Findings with Sources', callouts: [{ num: 1, title: 'Source labels are visually distinct and clickable', desc: 'The source elements are styled for immediate recognition and likely interactive.' }, { num: 2, title: 'Claims supported by cited references', desc: 'Each recommendation is backed by named sources, allowing users to verify the rationale.' }] },
      { subnavId: 'clarity-at', name: 'Alternatives & Trade-offs', description: 'Showing what the agent didn\'t choose and why helps users understand trade-offs. It creates transparency and supports participatory decision-making.', componentLabel: 'Component example: Suggested Actions', callouts: [{ num: 1, title: 'Consequences and benefits are explicit', desc: 'Includes options with a clear summary of what it changes and what the effect will be.' }, { num: 2, title: 'Multiple actions presented side-by-side', desc: 'The interface surfaces more than one possible action instead of a single automated path.' }, { num: 3, title: 'Supports informed trade-off decisions', desc: 'By presenting pros and cons transparently, the system helps users make context-aware decisions.' }, { num: 4, title: 'Labels indicate duration and reversibility', desc: 'Visual tags communicate whether an option is temporary, reversible, or long-term.' }] },
    ],
    howToImplement: ['Include reasoning explanations alongside every recommendation or decision', 'Make explanations accessible through plain language and visual aids', 'Use progressive disclosure to offer both quick summaries and detailed explanations', 'Show alternative options considered and why they were not chosen', 'Provide clear source citations and links for verification', 'Display confidence levels and uncertainty ranges where relevant'],
    commonPitfalls: [{ title: 'Opaque decision logic', description: 'Users can\'t tell why the agent made a choice' }, { title: 'Over explanation', description: 'Flooding users with too much technical detail and overwhelming them' }],
  },
  ...
  },
  {
    ...
    relatedPatterns: [
      { subnavId: 'collab-mi', name: 'Mixed Initiative', description: 'This pattern fosters adaptive turn-taking between human and agent. It supports fluid collaboration by allowing both to lead based on context.', componentLabel: 'Component example: Mixed Initiative', callouts: [{ num: 1, title: 'Agent proactively initiates based on context', desc: 'Allow the agent to proactively detect issues or make suggestions, especially when it has useful context the user may not.' }, { num: 2, title: 'Build on each other\'s contributions', desc: 'Design interactions so the agent can refine its outputs in response to human edits or questions.' }] },
      { subnavId: 'collab-ce', name: 'Co-editing Interfaces', description: 'Shared content and workspace for both AI and humans foster transparency — building clarity and trust.', componentLabel: 'Component example: Co-editing Interfaces', callouts: [{ num: 1, title: 'Keep AI suggestions non-intrusive', desc: 'Present changes as proposals, not automatic edits. Let users review, accept, modify, or reject.' }, { num: 2, title: 'Work in shared view', desc: 'Both AI and human should operate on the same content in the same workspace.' }, { num: 3, title: 'User always has final say', desc: 'The human is the editor-in-chief. AI assists, but never publishes or commits changes on its own.' }, { num: 4, title: 'Make editing modalities clear', desc: 'Let users choose how the AI helps — proofreading, rewriting, suggesting changes, etc.' }] },
      { subnavId: 'collab-rc', name: 'Role Clarity & Turn Signals', description: 'Clear handoffs and visible role signals reduce confusion in multi-step tasks. This makes collaboration feel more natural and efficient.', componentLabel: 'Component example: Role Clarity & Turn Signals', callouts: [{ num: 1, title: 'Clear stage-based ownership', desc: 'Break workflows into visible stages and indicate who leads each one.' }, { num: 2, title: 'Attribute every action', desc: 'Label actions clearly as system-initiated or human-initiated.' }, { num: 3, title: 'Signal when it\'s the user\'s turn', desc: 'Use prompts, buttons, or callouts to indicate when the system is waiting for user input.' }] },
    ],
