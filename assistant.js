    ...
    function inject() {
        ...
        panel.innerHTML = [
            '<div class="oa-header">',
              ...
              '<div>',
                '<div class="oa-title">Human-Agent Experience assistant</div>',
                '<div class="oa-sub">Outshift Design · Ask me anything</div>',
              '</div>',
            ...
            '<div class="oa-inputbar">',
              '<textarea class="oa-textarea" id="oa-input" placeholder="Ask about HAX patterns, research, navigation…" rows="1"></textarea>',
